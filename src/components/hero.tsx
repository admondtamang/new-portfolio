    ...
    <section className="body-font text-gray-600">
      <div className="container mx-auto flex flex-col items-center px-5 py-12 md:flex-row">
        <div className="mb-16 flex flex-col items-center gap-8 text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
          <p className="rounded-3xl border-4 border-gray-600 bg-white px-4 py-1 font-bold  ">
            Web Developer
          </p>
          <Highlight className="primary-highlight">
            <h1 className="title-font font-sans text-9xl font-extrabold text-gray-700  sm:text-4xl">
              Admond Tamang
            </h1>
          </Highlight>
          <h1 className="title-font font-sans text-9xl font-extrabold text-gray-700  sm:text-4xl">
          ...
          <div className="flex justify-center gap-4">
            <a href="https://www.linkedin.com/in/admond-tamang-78a39a134/">
              <button className="text-dark   text-md rounded border-2 border-black bg-indigo-300 py-2 px-6 shadow-offset-black hover:bg-lime-600 hover:text-lime-50">
                Linked In
              </button>
            </a>

            <a href="https://github.com/admondtamang">
              <button className="text-dark   text-md rounded border-2 border-black bg-lime-300 py-2 px-6 shadow-offset-black hover:bg-indigo-600 hover:text-lime-50">
                Github
              </button>
            </a>
          </div>
